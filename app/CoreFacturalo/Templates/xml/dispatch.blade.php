<DespatchAdvice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <cac:Shipment>
        ...
        <cbc:HandlingInstructions>{{ empty($document['transfer_reason_description']) ? $document['transfer_reason_type_name'] : $document['transfer_reason_description'] }}</cbc:HandlingInstructions>
