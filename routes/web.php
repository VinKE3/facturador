...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::get('documents/massive', 'Tenant\DocumentController@massive')->name('tenant.documents.massive');
            Route::post('documents/import_massive_documents', 'Tenant\DocumentController@ReadDataMassive');
            ...
            Route::prefix('dispatches')->group(function () {
                ...
                Route::get('/massive', 'Tenant\DispatchController@massive')->name('tenant.dispatches.massive');
                Route::post('/import_massive_dispatches', 'Tenant\DispatchController@ReadDataMassive');
            });
