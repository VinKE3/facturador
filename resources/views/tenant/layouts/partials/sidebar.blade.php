                            ...
                            <ul class="nav nav-children"
                                ...
                                @if(in_array('documents', $vc_modules) && $vc_company->soap_type_id != '03')
                                    @if(in_array('list_document', $vc_module_levels))
                                        <li class="{{ ($firstLevel === 'documents' && $secondLevel != 'create' && $secondLevel != 'not-sent' && $secondLevel != 'regularize-shipping' && $secondLevel != 'massive')?'nav-active':'' }}">
                                            <a class="nav-link"
                                ...
                                @if(auth()->user()->type != 'integrator' && in_array('documents', $vc_modules) )
                                    ...
                                    @if (in_array('documents', $vc_modules))
                                        <li class="{{ ($firstLevel === 'documents' && $secondLevel === 'massive') ? 'nav-active' : ''}}">
                                            <a class="nav-link" href="{{route('tenant.documents.massive')}}">Carga Masiva</a>
                                        </li>
                                    @endif
                                @endif
