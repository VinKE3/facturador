...
Vue.component('tenant-documents-massive', require('./views/tenant/documents/massive.vue'));
...
Vue.component('tenant-dispatches-massive', require('./views/tenant/dispatches/massive.vue'));
