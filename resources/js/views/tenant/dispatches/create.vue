                        ...
                        <div class="col-lg-12">
                            <div :class="{'has-danger': errors.origin_address_id}"
                                ...
                                <label class="control-label">Dirección partida<span class="text-danger"> *</span>
                                    <template v-if="form.transfer_reason_type_id !== '02'">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div :class="{'has-danger': errors.delivery_address_id}"
                                 class="form-group">
                                <label class="control-label">Dirección llegada<span class="text-danger"> *</span>
                                    <template v-if="form.transfer_reason_type_id === '02'">
                                        <a v-if="can_add_new_product"
                                           href="#"
                                           @click.prevent="showDialogOriginAddressForm = true">[+ Nuevo]</a>
...
export default {
    ...
    methods: {
        ...
        setDefaults() {
            if (this.form.number === '#') { //Significa que es uno nuevo y debe setear los valores por defecto
        ...
        changeTransferReasonType() {
            ...
            if (this.form.transfer_reason_type_id === '02') {
                let delivery_addresses = Object.assign([], this.origin_addresses)
                this.origin_addresses = this.delivery_addresses;
                this.delivery_addresses = delivery_addresses;

                let delivery_address_id = this.form.origin_address_id;
                this.form.origin_address_id = this.form.delivery_address_id;
                this.form.delivery_address_id = delivery_address_id;
            }
    ...
    watch: {
        'form.transfer_reason_type_id': function (newVal, oldVal) {
            if (oldVal === '02') {
                let origin_addresses = Object.assign([], this.delivery_addresses)
                this.delivery_addresses = this.origin_addresses;
                this.origin_addresses = origin_addresses;

                let origin_address_id = this.form.delivery_address_id;
                this.form.delivery_address_id = this.form.origin_address_id;
                this.form.origin_address_id = origin_address_id;
            }
        }
    }
}
